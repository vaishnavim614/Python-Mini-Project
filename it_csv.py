...
it_columns = {'INFOSYS': [2, 3], 'TCS': [4, 5], 'WIPRO': [6, 7], 'MAHINDRA':[8,9],'SONATA':[10,11]}
...
with open('output.csv') as csvfile:
    ...
    for row in reader:
        ...
        for it, columns in it_columns.items():
            ...
            transformed_data.append([it, date, rs, rm, sector])

# Write the transformed data to a new CSV file
with open('IT.csv', 'w', newline='') as csvfile:
